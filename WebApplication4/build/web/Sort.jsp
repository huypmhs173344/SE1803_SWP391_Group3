                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="table-data__tool">
                                        <div class="table-data__tool-left">
                                            ...
                                            <form action="sortOrder" method="get">       
                                                <div class="table-data__tool-right">
                                                    ...
                                                    <div class="rs-select2--light rs-select2--sm">
                                                        <select class="js-select2" name="time" onchange="window.location.href = this.value;" style="width: max-content;">
                                                            <option selected="selected" value="Sort?id=m">TIME</option>
                                                            <option value="Sort?id=o">OLD</option>
                                                            <option value="Sort?id=n">NEW</option>
                                                        </select>
                                                        <div class="dropDownSelect2"></div>
                                                    </div>
