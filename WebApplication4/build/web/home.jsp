                        ...
                        <div id="carouselId" class="carousel slide position-relative" data-bs-ride="carousel">
                            <div class="carousel-inner" role="listbox">
                                <div class="carousel-item active rounded">
                                    <img src="${top2Seller1.image}" class="img-fluid w-100 bg-secondary rounded" style="height:   300px" alt="First slide">
                                    <a href="#" class="btn px-4 py-2 text-white rounded">${top2Seller1.pname}</a>
                                </div>
                                <div class="carousel-item rounded">
                                    <img src="${top2Seller2.image}" class="img-fluid w-100 rounded" style="height:   300px"alt="Second slide">
            ...
            <div class="container py-5">
                <div class="tab-class text-center">
                            ...
                            <ul class="nav nav-pills d-inline-flex text-center mb-5"> <!-- all product -->
                                ...
                                <c:forEach var="c" items="${listC}">
                                    <li class="nav-item"> <!-- load cate -->
                                        <a class="d-flex py-2 m-2 bg-light rounded-pill" data-bs-toggle="pill" href="#${c.cname}">
                                            <span class="text-dark" style="width: 120px;">${c.cname}</span>
                                        </a>
                                    </li>
                                </c:forEach>
                            </ul>
                    ...
                    <div class="tab-content">
                                            ...
                                            <div class="col-md-6 col-lg-4 col-xl-3">
                                                <div class="rounded position-relative fruite-item">
                                                    <div class="fruite-img">
                                                        <img src="${p.image}" class="img-fluid w-100 rounded-top" style="height: 250px"alt="">
                                                    </div>
                                                    <div class="text-white bg-secondary px-3 py-1 rounded position-absolute" style="top: 10px; left: 10px;">${c.cname}</div>
                                                    <div class="p-4 border border-secondary border-top-0 rounded-bottom" >
                                                        <a href="detail?pid=${p.pid}"><h4  style="height: 75px;">${p.pname}</h4></a>
                        ...
                        <c:forEach var="c" items="${listC}">
                            <div id="${c.cname}" class="tab-pane fade show p-0">
                                <div class="row g-4">
                                    <div class="col-lg-12">
                                        <div class="row g-4">
                                            <c:forEach var="p" items="${AllP}">
                                                <c:if test="${p.cid == c.cid}">
                                                    <div class="col-md-6 col-lg-4 col-xl-3">
                                                        <div class="rounded position-relative fruite-item">
                                                            <div class="fruite-img">
                                                                <img src="${p.image}" class="img-fluid w-100 rounded-top" alt="" style="height: 250px">
                                                            </div>
                                                            <div class="text-white bg-secondary px-3 py-1 rounded position-absolute" style="top: 10px; left: 10px;">${c.cname}</div>
                                                            <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                                                <a href="detail?pid=${p.pid}"><h4  style="height: 75px;">${p.pname}</h4></a>
                        ...
                        <div class="col-lg-6 col-xl-4">
                            ...
                            <div class="p-4 rounded bg-light">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-6">
                                            <img src="${top8.image}" class="img-fluid rounded-circle w-100" style="height: 250px"alt="">
                                    </div>
                                    <div class="col-6">
                                        <a href="detail?pid=${top8.pid}" class="h5">${top8.pname}</a>
