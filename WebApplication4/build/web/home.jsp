                ...
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-md-12 col-lg-5">
                        <div id="carouselId" class="carousel slide position-relative" data-bs-ride="carousel">
                            <c:forEach var="tp" items="${top3Seller}">
                                <div class="carousel-inner" role="listbox">
                                    <div class="carousel-item active rounded"> <!<!-- load top product -->
                                        <img src="${tp.image}" class="img-fluid w-100 h-100 bg-secondary rounded" alt="First slide">
                                        <a href="#" class="btn px-4 py-2 text-white rounded">${tp.pname}</a>
                                    </div>                                
                                </div>
                            </c:forEach>
            ...
            <div class="container py-5">
                <div class="tab-class text-center">
                            ...
                            <ul class="nav nav-pills d-inline-flex text-center mb-5"> <!-- all product -->
                                <c:forEach var="c" items="${listC}">
                                    <li class="nav-item"> <!-- load cate -->
                                        <a class="d-flex py-2 m-2 bg-light rounded-pill" href="home?cid=${c.cid}">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade show p-0 active">  <!-- load all product -->
                            <div class="row g-4">
                                <div class="col-lg-12">
                                    <div class="row g-4">
                                        <div class="col-md-6 col-lg-4 col-xl-3">
                                            <div class="rounded position-relative fruite-item">
                                                <c:forEach var="pbc" items="${PbyC}">
                                                    <div class="fruite-img">
                                                        <img src="${pbc.image}" class="img-fluid w-100 rounded-top" alt="">
                                                    </div>
                                                    <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                                        <h4>${pbc.pname}</h4>
                                                        <p>${pbc.pdes}</p>
                                                        <div class="d-flex justify-content-between flex-lg-wrap">
                                                            <p class="text-dark fs-5 fw-bold mb-0">${pbc.price}</p>
                                                            <a href="addtocart?pid=${pbc.pid}" class="btn border border-secondary rounded-pill px-3 text-primary"><i class="fa fa-shopping-bag me-2 text-primary"></i> Add to cart</a>
                                                        </div>
                                                    </div>
                                                </c:forEach>     
                                            </div>
