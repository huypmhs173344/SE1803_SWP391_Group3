 ...
 * @author ADMIN
 */
@WebServlet(name="HomeSeverlet", urlPatterns={"/home"})
public class HomeSeverlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        request.setAttribute("AllP", dbh.getAllProduct());
        request.setAttribute("listC", dbh.getAllCategory());
        request.setAttribute("top2Seller1", dbh.top2Seller().get(0));
        request.setAttribute("top2Seller2", dbh.top2Seller().get(1));
        request.setAttribute("top8Seller", dbh.top8Seller());
