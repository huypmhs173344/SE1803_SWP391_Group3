                    ...
                    <div class="row g-5">
                        <div class="col-md-12 col-lg-6 col-xl-7">
                            <div class="row">
                                <div class="col-md-12 col-lg-6">
                                    <div class="form-item w-100">
                                        ...
                                        <input type="text" id="name" name="name" class="form-control" value="${sessionScope.acc.f_name}"> 
                                ...
                                <div class="col-md-12 col-lg-6">
                                    <div class="form-item w-100">
                                        ...
                                        <input type="text" id="moblie" name="mobile" class="form-control" value="${sessionScope.acc.phone}">
                            ...
                            <div class="form-item">
                                ...
                                <input type="text" name="address" id="address" class="form-control" value="${sessionScope.acc.addr}">
