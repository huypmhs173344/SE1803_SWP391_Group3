...
public class SortOrder extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<OrderShipping> i=odao.getAllOrder3(index);
        List<OrderShipping> i2=odao.getAllOrder2(index);
        if (request.getParameter("id").equals("o")){            
            ...
            List<OrderShipping> list = odao.getSortedOrdersByDateOldtoNew(i2);
            request.setAttribute("id", request.getParameter("id"));
            request.setAttribute("listO", list);
            request.getRequestDispatcher("SortByTime.jsp").forward(request, response);
        }
