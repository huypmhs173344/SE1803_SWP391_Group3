...
public class updateOrder extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        OrderShipping o1= o.getOrderbyID(oid);
        request.setAttribute("OrderUpdate", o1);
    ...
    throws ServletException, IOException {
        ...
        int oid1 = Integer.parseInt(request.getParameter("order_id"));
        OrderDAO db= new OrderDAO();
        db.updateOrder(oid1,Status1);
        response.sendRedirect("table?index=1");
    }
