...
public class OrderDAO {
    ...
    public List<OrderShipping> getAllOrder3(int index) {
        List<OrderShipping> list = new ArrayList<>();
        String query = "with x as(\n"
                + "Select Orders.*,Shipping.name,Shipping.phone,Shipping.address,ROW_NUMBER() over(order by Orders.date asc) as r\n"
                + "from Orders join Shipping\n"
                + "on Orders.order_id=Shipping.order_id)\n"
                + "select * from x where r between ?*5-4 and ?*5";
        try {
    ...
    public List<OrderShipping> getAllOrder4(int index) {
        List<OrderShipping> list = new ArrayList<>();
        String query = "with x as(\n"
                + "Select Orders.*,Shipping.name,Shipping.phone,Shipping.address,ROW_NUMBER() over(order by Orders.total_money asc) as r\n"
                + "from Orders join Shipping\n"
                + "on Orders.order_id=Shipping.order_id)\n"
                + "select * from x where r between ?*5-4 and ?*5";
        try {
    ...
    public List<OrderShipping> getAllOrder5(int index) {
        List<OrderShipping> list = new ArrayList<>();
        String query = "with x as(\n"
                + "Select Orders.*,Shipping.name,Shipping.phone,Shipping.address,ROW_NUMBER() over(order by Orders.total_money desc) as r\n"
                + "from Orders join Shipping\n"
                + "on Orders.order_id=Shipping.order_id)\n"
                + "select * from x where r between ?*5-4 and ?*5";
        try {
    ...
    public List<OrderShipping> getAllOrder2(int index) {
        List<OrderShipping> list = new ArrayList<>();
        String query = "with x as(\n"
                + "Select Orders.*,Shipping.name,Shipping.phone,Shipping.address,ROW_NUMBER() over(order by Orders.date desc) as r\n"
                + "from Orders join Shipping\n"
                + "on Orders.order_id=Shipping.order_id)\n"
                + "select * from x where r between ?*5-4 and ?*5";
        try {
    ...
    public static void main(String[] args) {
        ...
        List<OrderShipping> list1=o.GetOrdersbyUserID(8);
        for (OrderShipping orderShipping : list1) {
            System.out.println(orderShipping.getUser_id());
        }
    }
}
